...
class EnvironmentConfigLogSettings:
    ...
    Attributes:
        ...
        console_level (bool | Unset):
        enable_file (bool | Unset):
        file_level (bool | Unset):
        file_location (bool | Unset):
        enable_webhook_debugging (bool | Unset):
        enable_diagnostics (bool | Unset):
    """

    enable_console: bool | Unset = UNSET
    console_level: bool | Unset = UNSET
    enable_file: bool | Unset = UNSET
    file_level: bool | Unset = UNSET
    file_location: bool | Unset = UNSET
