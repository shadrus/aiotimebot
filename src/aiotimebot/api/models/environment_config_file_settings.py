...
class EnvironmentConfigFileSettings:
    """
    Attributes:
        max_file_size (bool | Unset):
        driver_name (bool | Unset):
        directory (bool | Unset):
        enable_public_link (bool | Unset):
        public_link_salt (bool | Unset):
        thumbnail_width (bool | Unset):
        thumbnail_height (bool | Unset):
        preview_width (bool | Unset):
        preview_height (bool | Unset):
        profile_width (bool | Unset):
        profile_height (bool | Unset):
        initial_font (bool | Unset):
        amazon_s3_access_key_id (bool | Unset):
        amazon_s3_secret_access_key (bool | Unset):
        amazon_s3_bucket (bool | Unset):
        amazon_s3_region (bool | Unset):
        amazon_s3_endpoint (bool | Unset):
        amazon_s3ssl (bool | Unset):
    """

    max_file_size: bool | Unset = UNSET
    driver_name: bool | Unset = UNSET
    directory: bool | Unset = UNSET
    enable_public_link: bool | Unset = UNSET
    public_link_salt: bool | Unset = UNSET
    thumbnail_width: bool | Unset = UNSET
    thumbnail_height: bool | Unset = UNSET
    preview_width: bool | Unset = UNSET
    preview_height: bool | Unset = UNSET
    profile_width: bool | Unset = UNSET
    profile_height: bool | Unset = UNSET
    initial_font: bool | Unset = UNSET
    amazon_s3_access_key_id: bool | Unset = UNSET
    amazon_s3_secret_access_key: bool | Unset = UNSET
    amazon_s3_bucket: bool | Unset = UNSET
    amazon_s3_region: bool | Unset = UNSET
    amazon_s3_endpoint: bool | Unset = UNSET
