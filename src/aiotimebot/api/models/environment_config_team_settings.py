...
class EnvironmentConfigTeamSettings:
    """
    Attributes:
        site_name (bool | Unset):
        max_users_per_team (bool | Unset):
        enable_team_creation (bool | Unset):
        enable_user_creation (bool | Unset):
        enable_open_server (bool | Unset):
        restrict_creation_to_domains (bool | Unset):
        enable_custom_brand (bool | Unset):
        custom_brand_text (bool | Unset):
        custom_description_text (bool | Unset):
        restrict_direct_message (bool | Unset):
        restrict_team_invite (bool | Unset):
        restrict_public_channel_management (bool | Unset):
        restrict_private_channel_management (bool | Unset):
        restrict_public_channel_creation (bool | Unset):
        restrict_private_channel_creation (bool | Unset):
        restrict_public_channel_deletion (bool | Unset):
        restrict_private_channel_deletion (bool | Unset):
        user_status_away_timeout (bool | Unset):
        max_channels_per_team (bool | Unset):
        max_notifications_per_channel (bool | Unset):
    """

    site_name: bool | Unset = UNSET
    max_users_per_team: bool | Unset = UNSET
    enable_team_creation: bool | Unset = UNSET
    enable_user_creation: bool | Unset = UNSET
    enable_open_server: bool | Unset = UNSET
    restrict_creation_to_domains: bool | Unset = UNSET
    enable_custom_brand: bool | Unset = UNSET
    custom_brand_text: bool | Unset = UNSET
    custom_description_text: bool | Unset = UNSET
    restrict_direct_message: bool | Unset = UNSET
    restrict_team_invite: bool | Unset = UNSET
    restrict_public_channel_management: bool | Unset = UNSET
    restrict_private_channel_management: bool | Unset = UNSET
    restrict_public_channel_creation: bool | Unset = UNSET
    restrict_private_channel_creation: bool | Unset = UNSET
    restrict_public_channel_deletion: bool | Unset = UNSET
    restrict_private_channel_deletion: bool | Unset = UNSET
    user_status_away_timeout: bool | Unset = UNSET
    max_channels_per_team: bool | Unset = UNSET
    max_notifications_per_channel: bool | Unset = UNSET
