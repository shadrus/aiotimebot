...
class ConfigSqlSettings:
    ...
    Attributes:
        ...
        data_source_replicas (list[str] | Unset):
        max_idle_conns (int | Unset):
        max_open_conns (int | Unset):
        trace (bool | Unset):
        at_rest_encrypt_key (str | Unset):
    """

    driver_name: str | Unset = UNSET
    data_source: str | Unset = UNSET
    data_source_replicas: list[str] | Unset = UNSET
    max_idle_conns: int | Unset = UNSET
    max_open_conns: int | Unset = UNSET
    trace: bool | Unset = UNSET
    at_rest_encrypt_key: str | Unset = UNSET
