...
class EnvironmentConfigSamlSettings:
    ...
    Attributes:
        ...
        encrypt (bool | Unset):
        idp_url (bool | Unset):
        idp_descriptor_url (bool | Unset):
        assertion_consumer_service_url (bool | Unset):
        idp_certificate_file (bool | Unset):
        public_certificate_file (bool | Unset):
        private_key_file (bool | Unset):
        ...
        locale_attribute (bool | Unset):
        position_attribute (bool | Unset):
        login_button_text (bool | Unset):
    """

    enable: bool | Unset = UNSET
    verify: bool | Unset = UNSET
    encrypt: bool | Unset = UNSET
    idp_url: bool | Unset = UNSET
    idp_descriptor_url: bool | Unset = UNSET
    assertion_consumer_service_url: bool | Unset = UNSET
    ...
    locale_attribute: bool | Unset = UNSET
    position_attribute: bool | Unset = UNSET
    login_button_text: bool | Unset = UNSET
