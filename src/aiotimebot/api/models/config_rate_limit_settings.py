...
class ConfigRateLimitSettings:
    ...
    Attributes:
        ...
        per_sec (int | Unset):
        max_burst (int | Unset):
        memory_store_size (int | Unset):
        vary_by_remote_addr (bool | Unset):
        vary_by_header (str | Unset):
    """

    enable: bool | Unset = UNSET
    per_sec: int | Unset = UNSET
    max_burst: int | Unset = UNSET
    memory_store_size: int | Unset = UNSET
    vary_by_remote_addr: bool | Unset = UNSET
    vary_by_header: str | Unset = UNSET
