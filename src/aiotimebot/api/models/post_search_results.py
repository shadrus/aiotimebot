...
if TYPE_CHECKING:
    ...
    from ..models.post_search_results_matches import PostSearchResultsMatches


T = TypeVar("T", bound="PostSearchResults")
...
class PostSearchResults:
    ...
    prev_post_id: str
    has_next: bool
    matches: PostSearchResultsMatches
    total: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        matches = PostSearchResultsMatches.from_dict(d.pop("matches"))

        total = d.pop("total")

        post_search_results = cls(
            order=order,
            posts=posts,
            next_post_id=next_post_id,
            prev_post_id=prev_post_id,
        ...
        post_search_results.additional_properties = d
