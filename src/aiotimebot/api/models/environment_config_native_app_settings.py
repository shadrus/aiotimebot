...
class EnvironmentConfigNativeAppSettings:
    """
    Attributes:
        app_download_link (bool | Unset):
        android_app_download_link (bool | Unset):
        ios_app_download_link (bool | Unset):
    """

    app_download_link: bool | Unset = UNSET
    android_app_download_link: bool | Unset = UNSET
    ios_app_download_link: bool | Unset = UNSET
