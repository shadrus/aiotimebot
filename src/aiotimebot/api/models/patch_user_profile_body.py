...
T = TypeVar("T", bound="PatchUserProfileBody")


@_attrs_define
class PatchUserProfileBody:
    ...
    hide_additional_contact: bool | Unset = UNSET
    schedule: str | Unset = UNSET
    hide_schedule: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if hide_additional_contact is not UNSET:
            field_dict["hide_additional_contact"] = hide_additional_contact
        if schedule is not UNSET:
            field_dict["schedule"] = schedule
        if hide_schedule is not UNSET:
            field_dict["hide_schedule"] = hide_schedule
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hide_additional_contact = d.pop("hide_additional_contact", UNSET)

        schedule = d.pop("schedule", UNSET)

        hide_schedule = d.pop("hide_schedule", UNSET)
        ...
        patch_user_profile_body.additional_properties = d
        return patch_user_profile_body
