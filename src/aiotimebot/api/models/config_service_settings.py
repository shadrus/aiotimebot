...
class ConfigServiceSettings:
    ...
    Attributes:
        site_url (str | Unset):
        listen_address (str | Unset):
        connection_security (str | Unset):
        tls_cert_file (str | Unset):
        tls_key_file (str | Unset):
        use_lets_encrypt (bool | Unset):
        lets_encrypt_certificate_cache_file (str | Unset):
        forward_80_to_443 (bool | Unset):
        read_timeout (int | Unset):
        write_timeout (int | Unset):
        maximum_login_attempts (int | Unset):
        segment_developer_key (str | Unset):
        google_developer_key (str | Unset):
        ...
        allow_cors_from (str | Unset):
        session_length_web_in_days (int | Unset):
        session_length_mobile_in_days (int | Unset):
        session_length_sso_in_days (int | Unset):
        session_cache_in_minutes (int | Unset):
        websocket_secure_port (int | Unset):
        websocket_port (int | Unset):
        webserver_mode (str | Unset):
        enable_custom_emoji (bool | Unset):
        restrict_custom_emoji_creation (str | Unset):
    """

    site_url: str | Unset = UNSET
    listen_address: str | Unset = UNSET
    connection_security: str | Unset = UNSET
    tls_cert_file: str | Unset = UNSET
    tls_key_file: str | Unset = UNSET
    use_lets_encrypt: bool | Unset = UNSET
    lets_encrypt_certificate_cache_file: str | Unset = UNSET
    forward_80_to_443: bool | Unset = UNSET
    read_timeout: int | Unset = UNSET
    write_timeout: int | Unset = UNSET
    maximum_login_attempts: int | Unset = UNSET
    segment_developer_key: str | Unset = UNSET
    google_developer_key: str | Unset = UNSET
    ...
    allow_cors_from: str | Unset = UNSET
    session_length_web_in_days: int | Unset = UNSET
    session_length_mobile_in_days: int | Unset = UNSET
    session_length_sso_in_days: int | Unset = UNSET
    session_cache_in_minutes: int | Unset = UNSET
    websocket_secure_port: int | Unset = UNSET
    websocket_port: int | Unset = UNSET
    webserver_mode: str | Unset = UNSET
    enable_custom_emoji: bool | Unset = UNSET
    restrict_custom_emoji_creation: str | Unset = UNSET
