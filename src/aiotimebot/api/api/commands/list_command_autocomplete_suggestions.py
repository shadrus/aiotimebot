...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v4/teams/{team_id}/commands/autocomplete_suggestions".format(
...
) -> AppError | list[AutocompleteSuggestion] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AppError | list[AutocompleteSuggestion]]:
    return Response(
